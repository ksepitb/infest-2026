          ...
          >
            <div className="rounded-3xl bg-[#020003] px-8 py-10 text-center shadow-[inset_2px_2px_8px_rgba(255,255,255,0.08)] sm:px-14 sm:py-14">
              <p className="text-base leading-relaxed text-white/90 sm:text-lg">
                Business Case Competition (BCC) adalah kompetisi{" "}
                <span className="text-golden-gradient">
                  memecahkan masalah bisnis nyata (real-world business case)
                </span>{" "}
                yang dihadapi suatu perusahaan, lalu mempresentasikan solusi
                strategisnya di hadapan dewan juri profesional.
              </p>
            </div>
          </div>
        </div>
