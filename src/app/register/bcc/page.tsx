...
const bccRules = [
  ...
  "Setiap peserta tidak diperbolehkan berada di lebih dari 1 tim pada BCC INFEST 2026.",
  "Anggota dalam tim tidak boleh digantikan oleh siapa pun dengan alasan apa pun.",
  "1 tim hanya boleh mengirimkan 1 karya pada BCC INFEST 2026.",
  ...
  "Peserta wajib mengikuti akun Instagram @infest.bdg untuk mendapatkan informasi mengenai perlombaan.",
  "Peserta wajib memposting twibbon yang disediakan oleh panitia sebagai syarat registrasi. Ketentuan twibbon dapat diakses melalui link https://bit.ly/PosterTwibbonBCC2026",
  "Peserta wajib membagikan poster lomba pada story akun Instagram masing-masing dan men-tag @infest.bdg sebagai syarat registrasi. Ketentuan terkait poster dapat diakses melalui link https://bit.ly/PosterTwibbonBCC2026",
  "Peserta wajib mentag 3 teman pada kolom komentar di postingan poster yang ada di akun Instagram @infest.bdg.",
  ...
  "Karya yang dikirimkan oleh peserta merupakan karya orisinal yang belum pernah dipublikasikan di media atau platform mana pun.",
  "Setiap tim wajib mengikuti workshop yang telah difasilitasi oleh panitia.",
