...
export const metadata: Metadata = {
  ...
  description: "Ketentuan umum Equity Research Competition INFEST 2026.",
  openGraph: {
    title: "Ketentuan Umum ERC | INFEST 2026",
    description:
      "Baca ketentuan umum Equity Research Competition INFEST 2026 sebelum mendaftar.",
...
const ercRules = [
  ...
  "Setiap peserta tidak diperbolehkan berada pada lebih dari 1 tim pada ERC INFEST 2026",
  "Anggota dalam tim tidak boleh digantikan oleh siapa pun dengan alasan apa pun.",
  "1 tim hanya boleh mengirimkan 1 karya pada ERC INFEST 2026.",
  "Peserta tidak sedang bekerja atau terafiliasi dengan suatu sekuritas.",
  ...
  "Peserta wajib mem-posting twibbon yang disediakan oleh panitia untuk mengikuti lomba. Ketentuan twibbon dapat diakses melalui link bit.ly/PosterTwibbonERC2026",
  "Peserta wajib menandai 3 teman pada kolom komentar di postingan poster yang ada di akun Instagram @infest.bdg.",
  "Peserta wajib membagikan poster lomba pada story akun instagram masing-masing dan men-tag @infest.bdg sebagai syarat registrasi. Ketentuan terkait poster dapat diakses melalui link bit.ly/PosterTwibbonERC2026",
...
export default function ErcRulesPage() {
  return (
