...
const prizes: PrizeItem[] = [
  {
    rank: "Juara 1",
    prize: "Rp5.000.000,00 + sertifikat",
    badgeClassName:
    ...
    textClassName:
      "font-poppins text-xl font-bold text-white whitespace-nowrap drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)] sm:text-2xl lg:text-[28px]",
  },
  {
    rank: "Juara 2",
    prize: "Rp3.000.000,00 + sertifikat",
    badgeClassName:
    ...
    textClassName:
      "font-poppins text-xl font-bold text-white whitespace-nowrap drop-shadow-[0_2px_6px_rgba(0,0,0,0.75)] sm:text-2xl lg:text-[28px]",
  },
  {
    rank: "Juara 3",
    prize: "Rp2.000.000,00 + sertifikat",
    badgeClassName:
...
export function BccPrizePool() {
  return (
    <section
      className="mx-auto flex w-full max-w-6xl scroll-mt-32 flex-col items-center gap-[61px] px-4 py-12 sm:px-6 sm:py-16 md:py-20 lg:px-8 lg:py-12"
      id="bcc-prize-pool"
    >
      ...
      <div className="flex w-full max-w-full flex-col items-center gap-6">
        {prizes.map((item) => (
          <div
            key={item.rank}
            className="flex w-full max-w-[976px] flex-col items-center justify-center gap-4 break-words sm:flex-row sm:gap-6 lg:gap-[24px]"
          >
            <div className={item.badgeClassName}>
              <span className={item.textClassName}>{item.rank}</span>
            </div>
            <p className="font-poppins text-shadow-links text-center text-xl leading-[100%] font-semibold text-white md:text-3xl lg:text-[36px]">
              {item.prize}
            </p>
          </div>
        ))}
