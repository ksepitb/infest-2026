        ...
        return (
          ...
          >
            <button
              ...
              className="flex w-full cursor-pointer items-center justify-between px-6 py-4 text-left text-sm font-medium text-white transition-colors duration-300 hover:bg-white/5 sm:px-8 sm:text-lg"
            >
